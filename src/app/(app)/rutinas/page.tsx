...
import { Plus, Copy, Share2, Trash2, Play, Download } from "lucide-react";
          ...
          {mine?.map((r) => (
            <Card key={r.id} className="flex flex-col gap-3" style={{ borderColor: `${r.color}44` }}>
              ...
              <div className="mt-auto flex items-center gap-1.5">
                <Button size="sm" onClick={() => start.mutate({ routineId: r.id })} loading={start.isLoading}>
                  <Play className="h-3.5 w-3.5" /> Entrenar
                </Button>
